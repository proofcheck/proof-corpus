...
# d = {"Hello":"World"}
d = {}
d2 = {"Math":0, "CS":0, "Phys":0, "Biology":0, "Systems": 0, "Econ": 0}
d3 = {0: "Math", 1: "CS", 2: "Phys", 3: "Biology", 4: "Systems", 5: "Econ"}
d4 = {"Math":0, "CS":1, "Phys":2, "Biology":3, "Systems": 4, "Econ": 5}
d5 = {}
types = {'math.CO': 'Math', 'math.NT': 'Math', 'hep-th': 'Phys', 'math.FA': 'Math', 'math.OA': 'Math', 'math.AC': 'Math', 'math.AG': 'Math', 'math.GT': 'Math', 'math.QA': 'Math', 'math.RT': 'Math', 'nlin.CG': 'Systems', 'cs.DM': 'CS', 'cs.LO': 'CS', 'math.DG': 'Math', 'math.RA': 'Math', 'math-ph': 'Math', 'math.MP': 'Math', 'math.SG': 'Math', 'math.GR': 'Math', 'math.AT': 'Math', 'math.CT': 'Math', 'math.PR': 'Math', 'math.ST': 'Math', 'stat.TH': 'Math', 'math.CV': 'Math', 'math.OC': 'Math', 'math.CA': 'Math', 'math.AP': 'Math', 'math.DS': 'Math', 'math.GM': 'Math', 'stat.CO': 'Math', 'quant-ph': 'Phys', 'math.KT': 'Math', 'cs.CG': 'CS', 'cs.NE': 'CS', 'cs.GT': 'CS', 'cs.CC': 'CS', 'math.NA': 'Math', 'gr-qc': 'Phys', 'nlin.SI': 'Systems', 'cs.CR': 'CS', 'cs.DC': 'CS', 'cs.SC': 'CS', 'math.MG': 'Math', 'cs.LG': 'CS', 'q-bio.GN': 'Biology', 'q-bio.QM': 'Biology', 'nlin.CD': 'Systems', 'cs.IR': 'CS', 'cs.AI': 'CS', 'cs.DS': 'CS', 'math.LO': 'Math', 'math.GN': 'Math', 'math.SP': 'Math', 'cs.NI': 'CS', 'cs.CL': 'CS', 'cond-mat.other': 'Phys', 'astro-ph': 'Phys', 'q-bio.SC': 'Biology', 'cs.PL': 'CS', 'nlin.PS': 'Math', 'cond-mat.stat-mech': 'Phys', 'cs.DB': 'CS', 'adap-org': 'Systems', 'nlin.AO': 'Systems', 'q-bio': 'Biology', 'alg-geom': 'Math', 'q-alg': 'Math', 'chao-dyn': 'Systems', 'cmp-lg': 'CS', 'cond-mat': 'Phys', 'cond-mat.str-el': 'Phys', 'cond-mat.dis-nn': 'Phys', 'cond-mat.soft': 'Phys', 'cond-mat.mes-hall': 'Phys', 'q-bio.PE': 'Biology', 'physics.soc-ph': 'Phys', 'cs.CE': 'CS', 'cs.CV': 'CS', 'cs.NA': 'CS', 'cs.AR': 'CS', 'cs.MA': 'CS', 'cs.SE': 'CS', 'cs.PF': 'CS', 'q-bio.BM': 'Biology', 'cs.GR': 'CS', 'physics.data-an': 'Phys', 'cs.RO': 'CS', 'cs.CY': 'CS', 'cs.OH': 'CS', 'cs.DL': 'CS', 'cs.GL': 'CS', 'cs.MS': 'CS', 'cs.HC': 'CS', 'cs.MM': 'CS', 'q-bio.MN': 'Biology', 'dg-ga': 'Math','funct-an': 'Math', 'hep-lat': 'Phys', 'hep-ph': 'Phys', 'physics.class-ph': 'Phys', 'math.HO': 'Math', 'physics.chem-ph': 'Phys', 'physics.flu-dyn': 'Phys', 'physics.atom-ph': 'Phys', 'physics.comp-ph': 'Phys', 'physics.geo-ph': 'Phys', 'physics.optics': 'Phys', 'stat.ML': 'Math', 'physics.plasm-ph': 'Phys', 'q-bio.TO': 'Biology', 'solv-int': 'Math', 'nucl-th': 'Phys', 'nucl-ex': 'Phys', 'patt-sol': 'Systems', 'physics.bio-ph': 'Phys', 'physics.gen-ph': 'Phys', 'physics.ed-ph': 'Phys', 'physics.acc-ph': 'Phys', 'q-bio.OT': 'Biology', 'q-bio.CB': 'Biology', 'q-bio.NC': 'Biology', 'stat.AP': 'Math', 'stat.ME': 'Math', 'cs.IT': 'CS', 'math.IT': 'Math', 'cond-mat.mtrl-sci': 'Phys', 'physics.ao-ph': 'Phys', 'physics.hist-ph': 'Phys', 'cond-mat.supr-con': 'Phys', 'cs.OS': 'CS', 'bayes-an': 'Phys', 'comp-gas': 'Phys', 'physics.space-ph': 'Phys', 'physics.ins-det': 'Phys', 'q-fin.PR': 'Econ', 'q-fin.CP': 'Econ', 'q-fin.ST': 'Econ', 'q-fin.RM': 'Econ', 'q-fin.GN': 'Econ', 'q-fin.PM': 'Econ', 'q-fin.TR': 'Econ', 'astro-ph.EP': 'Phys', 'cs.FL': 'CS', 'astro-ph.SR': 'Phys', 'astro-ph.HE': 'Phys', 'cond-mat.quant-gas': 'Phys', 'astro-ph.GA': 'Phys', 'astro-ph.CO': 'Phys', 'physics.atm-clus': 'Phys', 'stat.OT': 'Math', 'cs.SY': 'CS', 'physics.med-ph': 'Phys', 'cs.SI': 'CS', 'hep-ex': 'Phys', 'cs.ET': 'CS', 'astro-ph.IM': 'Phys', 'physics.pop-ph': 'Phys', 'cs.SD': 'CS', 'q-fin.MF': 'Econ', 'q-fin.EC': 'Econ', 'physics.app-ph': 'Phys', 'econ.EM': 'Econ', 'eess.SP': 'Systems', 'eess.AS': 'Systems', 'eess.IV': 'Systems', 'econ.TH': 'Systems', 'econ.GN': 'Econ', 'eess.SY': 'Systems'}
yearCats = [[0,0,0,0,0,0] for l in years]
