...
class ArxivProofs(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        datasets.BuilderConfig(name="proofs", version=VERSION, description="Full proofs"),
        datasets.BuilderConfig(name="sentences", version=VERSION, description="Individual sentences from proofs"),
    ]
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "filepath": data_file, # os.path.join(data_dir, "train.jsonl"),
                    "split": "train",
                },
            ),
            # datasets.SplitGenerator(
